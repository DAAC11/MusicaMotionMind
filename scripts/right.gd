...
func control():
	if Input.is_action_just_pressed("ui_right") and !Colbien and !ColExcelente and !ColPerfecto:
		GameManager.combo =0
		$AnimationPlayer.play("error")
		
	elif Input.is_action_just_pressed("ui_right") and ColPerfecto:
		GameManager.combo +=1
	...
	elif Input.is_action_just_pressed("ui_right") and ColExcelente:
		GameManager.combo +=1
	...
	elif Input.is_action_just_pressed("ui_right") and Colbien:
		GameManager.combo +=1
		GameManager.bien +=1
		GameManager.aciertos +=1
